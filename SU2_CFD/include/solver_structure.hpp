...
// TODO: This is what I am editing
/*! \class CMaxwellSolver
 *  \brief Main class for defining the finite-volume Maxwell solver.
 *  \author Wenyin Wei
 *  \date January 19, 2018.
 */
class CMaxwellSolver : public CSolver {
protected:
  unsigned short nVarFlow, nMarker, CurrentMesh;
  su2double *Heat_Flux, *Surface_HF, Total_HeatFlux, AllBound_HeatFlux,
            *AvgTemperature, Total_AvgTemperature, AllBound_AvgTemperature,
...
public:
   ...
   * \brief Constructor of the class.
   */
  CMaxwellSolver(CGeometry *geometry, CConfig *config, unsigned short iMesh);

  /*!
   * \brief Destructor of the class.
   */
  virtual ~CMaxwellSolver(void);
